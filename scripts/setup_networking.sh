...
iptables --table nat --append PREROUTING --source 0.0.0.0/0 --destination 128.8.37.122 --jump DNAT --to-destination 172.20.0.4
iptables --table nat --append PREROUTING --source 0.0.0.0/0 --destination 128.8.37.116 --jump DNAT --to-destination 172.20.0.4
...
iptables --table nat --append POSTROUTING --source 172.20.0.4 --destination 0.0.0.0/0 --jump SNAT --to-source 128.8.37.122
iptables --table nat --append POSTROUTING --source 172.20.0.4 --destination 0.0.0.0/0 --jump SNAT --to-source 128.8.37.116
